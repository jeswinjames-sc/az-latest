...
import { NonMedFormGroup, AlcoholDoctorsFormGroup, DetoxDoctorsFormGroup } from '@form-group/e-app/non-med-form-group';
...
import * as SymptomSpecs from '@form/column-specs/e-application/symptoms-col-specs';
...
export const MedConsultationCol: ColumnGeneratorSpecs = {
    ...
    field: {
        ...
        fieldName: 'Medical consultation non med, including Annual Physical Exams or Executive Check-ups',
        setFieldName: false,
...
export const DidSeekSupportRehabRow: RowGeneratorSpecs = {
    columns: [DidSeekSupportRehabCol]
};
            ...
            columns: [
                {
                    ...
                    field: {
                        ...
                        setFieldName: false,
                        formGroup: NonMedFormGroup,
                        conditionalFunction: () => setDrugDateValidation(NonMedFormGroup, 'hadOpiates', ['hadOpiatesFrom' ,'hadOpiatesTo'])
                    }
                },
                {
                    size: 2,
            ...
            columns: [
                {
                    ...
                    field: {
                        ...
                        setFieldName: false,
                        formGroup: NonMedFormGroup,
                        conditionalFunction: () => setDrugDateValidation(NonMedFormGroup, 'hadBarbiturates', ['hadBarbituratesFrom' ,'hadBarbituratesTo'])
                    }
                },
                {
                    size: 2,
            ...
            columns: [
                {
                    ...
                    field: {
                        ...
                        setFieldName: false,
                        formGroup: NonMedFormGroup,
                        conditionalFunction: () => setDrugDateValidation(NonMedFormGroup, 'hadSedatives', ['hadSedativesFrom' ,'hadSedativesTo'])
                    }
                },
                {
                    size: 2,
            ...
            columns: [
                {
                    ...
                    field: {
                        ...
                        setFieldName: false,
                        formGroup: NonMedFormGroup,
                        conditionalFunction: () => setDrugDateValidation(NonMedFormGroup, 'hadAphetamines', ['hadAphetaminesFrom' ,'hadAphetaminesTo'])
                    }
                },
                {
                    size: 2,
            ...
            columns: [
                {
                    ...
                    field: {
                        ...
                        setFieldName: false,
                        formGroup: NonMedFormGroup,
                        conditionalFunction: () => setDrugDateValidation(NonMedFormGroup, 'hadCocaine', ['hadCocaineFrom' ,'hadCocaineTo'])
                    }
                },
                {
                    size: 2,
            ...
            columns: [
                {
                    ...
                    field: {
                        ...
                        setFieldName: false,
                        formGroup: NonMedFormGroup,
                        conditionalFunction: () => setDrugDateValidation(NonMedFormGroup, 'hadHallucinogens', ['hadHallucinogensFrom' ,'hadHallucinogensTo'])
                    }
                },
                {
                    size: 2,
            ...
            columns: [
                {
                    ...
                    field: {
                        ...
                        setFieldName: false,
                        formGroup: NonMedFormGroup,
                        conditionalFunction: () => setDrugDateValidation(NonMedFormGroup, 'hadCannabis', ['hadCannabisFrom' ,'hadCannabisTo'])
                    }
                },
                {
                    size: 2,
            ...
            columns: [
                {
                    ...
                    field: {
                        ...
                        setFieldName: false,
                        formGroup: NonMedFormGroup,
                        conditionalFunction: () => setDrugDateValidation(NonMedFormGroup, 'hadSolvents', ['hadSolventsFrom' ,'hadSolventsTo'])
                    }
                },
                {
                    size: 2,
            ...
            columns: [
                {
                    ...
                    field: {
                        ...
                        setFieldName: false,
                        formGroup: NonMedFormGroup,
                        conditionalFunction: () => setDrugDateValidation(NonMedFormGroup, 'hadOthers', ['hadOthersFrom' ,'hadOthersTo'])
                    }
                },
                {
                    size: 2,
    ...
    columns: [
        {
            ...
            field: {
                ...
                conditionalFunction: () => {
                    ...
                    if(nullable.includes(NonMedFormGroup.get('isPregnant').value)) {
                        PregnantWeeksFieldCol.isHidden = true;
                        NonMedFormGroup.get('pregnantWeeks').reset();
                        NonMedFormGroup.get('pregnantWeeks').clearValidators();
                        NonMedFormGroup.get('pregnantWeeks').updateValueAndValidity();
                    } else {
                        PregnantWeeksFieldCol.isHidden = false;
                        NonMedFormGroup.get('pregnantWeeks').setValidators([Validators.required, Validators.min(1), Validators.max(42)]);
                    }
                }
            }
        },
