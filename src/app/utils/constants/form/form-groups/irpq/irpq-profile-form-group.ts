...
export const IrpqProfileFormGroup: FormGroup = new FormBuilder().group({
  profileOption1: [false, [
    Validators.required
  ]],
  profileOption2: [false, [
    Validators.required
  ]],
  profileOption3: [false, [
    Validators.required
  ]],
  profileOption4: [false, [
    Validators.required
  ]],
  profileOption5: [false, [
    Validators.required
  ]],
  profileOption6: [false, [
    Validators.required
  ]],
  profileOption7: [false, [
    Validators.required
  ]],
  profileOption8: [false, [
    Validators.required
  ]],
});
