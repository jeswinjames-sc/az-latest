...
export const SISummaryFormBuilder: FormBuilder = new FormBuilder();


export const SISummaryAOFormGroupControl = {
  firstName: [''],
  middleName: [''],
  lastName: [''],
  dateOfBirth: [''],
...
export const SISummaryPIFormGroupControl = {
  firstName: [''],
  middleName: [''],
  lastName: [''],
  dateOfBirth: [''],
...
export const SISummaryPlanFormGroupControl = {
  planName: [''],
...
export const SISummaryIHPCoverageFormGroupControl = {
  planName: [''],
  annualPlanLimit: [''],
  modeOfPayment: [''],
  areaOfCover: [''],
...
export const RiderFundTWFormGroup: FormGroup = new FormBuilder().group({
...
export const SISummaryAOFormGroup: FormGroup = SISummaryFormBuilder.group(SISummaryAOFormGroupControl);

export const SISummaryPIFormGroup: FormGroup = SISummaryFormBuilder.group(SISummaryPIFormGroupControl);

export const SISummaryPlanFormGroup: FormGroup = SISummaryFormBuilder.group(SISummaryPlanFormGroupControl);

export const SISummaryIHPCoverageFormGroup: FormGroup = SISummaryFormBuilder.group(SISummaryIHPCoverageFormGroupControl);
